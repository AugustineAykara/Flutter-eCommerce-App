        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              "TOP TRENDING",
              style: TextStyle(
                  fontFamily: "Calistoga", fontSize: 25, color: Colors.black),
            ),
          ),
          SizedBox(
            height: MediaQuery.of(context).size.height *
                0.65, //<-- set height of the card
            child: PageView(controller: pagecontroller, children: <Widget>[
              CarouselSlider(
                  items: [
                    Slidcard(
                        name: "WRONG",
                        sub: "Men green Sneakers",
                        assetName: "ind.jpg"),
                    Slidcard(
                        name: "",
                        sub: "Men black sneakers",
                        assetName: "in.jpg"),
                    Slidcard(
                        name: "ROADESTER",
                        sub: "Men taupe sneaker",
                        assetName: "inde.jpg"),
                  ].map((i) {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(22)), //<--custom shape
      child: Column(
        children: <Widget>[
          ClipRRect(
            //<--clipping image
